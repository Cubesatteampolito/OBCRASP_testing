...
class attitudeADCS(Structure):
	...
	def __str__(self):
		return "attitudeADCS <c_float omega_x> <c_float omega_y> <c_float omega_z> <c_float b_x> <c_float b_y> <c_float b_z> <c_float theta_x> <c_float theta_y> <c_float theta_z> <c_float suntheta_x> <c_float suntheta_y> <c_float suntheta_z> <c_uint32 ticktime>"

	convList=[int,float,float,float,float,float,float,float,float,float,float,float,float,int]
...
class setAttitudeADCS(Structure):
	...
	def __str__(self):
		return "setAttitudeADCS <c_float domega_x> <c_float domega_y> <c_float domega_z> <c_float db_x> <c_float db_y> <c_float db_z> <c_float dtheta_x> <c_float dtheta_y> <c_float dtheta_z>"

	convList=[int,float,float,float,float,float,float,float,float,float]
